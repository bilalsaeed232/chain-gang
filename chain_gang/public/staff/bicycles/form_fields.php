...
<dl>
  ...
  <dd>
    ...
    <?php for($year=$this_year-20; $year <= $this_year; $year++) { ?>
      <option value="<?php echo $year; ?>" <?php echo ($bicycle->year == $year ? "selected" : NULL) ?> ><?php echo $year; ?></option>
    <?php } ?>
    </select>
  </dd>
</dl>
...
<dl>
  ...
  <dd>
    ...
    <?php foreach(Bicycle::CATEGORIES as $category) { ?>
      <option value="<?php echo $category; ?>" <?php echo ($bicycle->category ? "selected" : NULL) ?>><?php echo $category; ?></option>
    <?php } ?>
    </select>
  </dd>
</dl>
...
<dl>
  ...
  <dd>
    ...
    <?php foreach(Bicycle::GENDERS as $gender) { ?>
      <option value="<?php echo $gender; ?>" <?php echo ($bicycle->gender == $gender ? "selected": NULL) ?>><?php echo $gender; ?></option>
    <?php } ?>
    </select>
  </dd>
</dl>
...
<dl>
  ...
  <dd>
    ...
    <?php foreach(Bicycle::CONDITION_OPTIONS as $cond_id => $cond_name) { ?>
      <option value="<?php echo $cond_id; ?>" <?php echo ($bicycle->condition_id == $cond_id ? "selected" : NULL) ?>><?php echo $cond_name; ?></option>
    <?php } ?>
    </select>
  </dd>
</dl>
...
<dl>
  <dt>Description</dt>
  <dd>
    <textarea name="bicycle[description]" rows="5" cols="50"><?php echo $bicycle->description ?></textarea>
  </dd>
</dl>
